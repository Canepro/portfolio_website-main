...
For this run configuration (), it also filed [Issue #90](https://github.com/Canepro/pipelinehealer-demo/issues/90) as a tracking artifact with the full diagnosis context: failure type, confidence, evidence lines, and the remediation action taken.
