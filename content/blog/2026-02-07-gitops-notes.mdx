...
date: "2026-02-07"
description: "GitOps patterns from running Argo CD on OCI and Azure."
...
The key insight: GitOps is infrastructure as a feedback loop. Storing YAML in Git is not the value; the reconciler closing the gap is.
