    ...
    <div
      className={[
        ...
        accent
          ...
          : 'border-[color:var(--color-border)] bg-[color:var(--color-card-bg)] hover:bg-[color:var(--color-card-hover)]',
      ].join(' ')}
    >
      <div className="flex items-center gap-2">
        <div className="grid h-8 w-8 place-items-center rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-card-bg)] text-[color:var(--color-text-secondary)]">
          {icon}
        </div>
        <div className="min-w-0">
          ...
          <div className="truncate text-[10px] font-mono text-[color:var(--color-text-secondary)] opacity-80">
            {sub}
          </div>
        </div>
      </div>
...
export default function HeroVisual() {
  ...
  return (
    <div
      data-hero-visual
      className="relative h-[240px] w-full overflow-hidden rounded-3xl border border-[color:var(--color-border)] bg-[color:var(--color-card-bg)] md:h-full md:min-h-[440px]"
    >
      ...
      <motion.div
        aria-hidden="true"
        className="absolute -bottom-20 right-[-40px] h-72 w-72 rounded-full bg-[color:var(--color-card-hover)] blur-3xl"
      ...
      <div className="relative flex h-full flex-col p-5 md:p-6">
        <div className="flex items-center justify-between gap-4">
          <div className="text-[11px] font-semibold uppercase tracking-widest text-[color:var(--color-text-secondary)] opacity-80">
            Systems Snapshot
          </div>
          <div className="hidden items-center gap-2 md:flex">
            <span className="rounded-full border border-[color:var(--color-border)] bg-[color:var(--color-card-bg)] px-2.5 py-1 text-[10px] font-mono text-[color:var(--color-text-secondary)] opacity-80">
              Netlify: deploy previews
            </span>
            <span className="text-[10px] font-mono text-[color:var(--color-text-secondary)] opacity-70">
              gitops · ci · k8s · obs
            </span>
          </div>
        </div>
        ...
        <div className="mt-4 flex-1">
          <div className="hidden h-full items-center md:flex">
            <div className="relative grid w-full min-w-0 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3">
              ...
              <div className="flex shrink-0 items-center justify-center text-[color:var(--color-text-secondary)] opacity-50">
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-3 border-t border-[color:var(--color-border)] bg-[color:var(--color-card-bg)] px-4 py-3 backdrop-blur">
        <div className="text-xs text-[color:var(--color-text-secondary)]">
          This portfolio is a working system, not a slide.
        </div>
        <div className="hidden text-xs text-[color:var(--color-text-secondary)] opacity-80 md:block">
