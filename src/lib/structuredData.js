...
export const personStructuredData = {
  ...
  description:
    'Multifaceted DevOps Engineer, Cloud Architect, and Frontend Developer based in the UK',
...
export const portfolioStructuredData = {
  ...
  description:
    'A comprehensive portfolio showcasing DevOps engineering, cloud architecture, and frontend development projects',
  author: {
    '@type': 'Person',
    name: 'Vincent Mogah',
    jobTitle: 'DevOps Engineer & Frontend Developer',
